...
object chuji {
  ...
  def main(args: Array[String]): Unit = {
   ...
   // sc.setLogLevel("INFO")
    ...
    val rawData = sc.textFile("d://SparkProject//demo1//src//testdata//u.data")
    //jie -查看第一条数据
    rawData.first()
    ...
    //val movies = sc.textFile("d://u.item")
    val movies = sc.textFile("d://SparkProject//demo1//src//testdata//u.item")
    //取两个数据,产品编号和产品名字
